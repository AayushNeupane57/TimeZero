    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => RestaurantPage( hotel: h1,distanceOfRestaurant:distanceToDisplay),
            ));
      },
      child: Container(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        onPressed: (){
                          if (str=="hours"){setState(() { str="min  ";

                          });}
                          else{setState(() { str="hours";
  ...
  Widget build(BuildContext context) {
    if (widget.foodCart.length==0) {
      return Scaffold(
        ...
        body: Center(
          child: Text("Your Cart is Empty", style: TextStyle(fontSize: 30),
          ),
        ),
      );
    }
